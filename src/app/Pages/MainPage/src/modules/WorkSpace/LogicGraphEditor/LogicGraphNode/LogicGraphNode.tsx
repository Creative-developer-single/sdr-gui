...
export function LogicGraphNode( { nodeID } ){
    ...
    return (
        <div>
            <FloatWindowWithoutTitle WindowInitialData={windowData} onUpdateStatus={onUpdateStatus} isRelative={false}>
                <div className="w-full h-full flex flex-col bg-white pb-3">{/*节点最上层容器*/}
