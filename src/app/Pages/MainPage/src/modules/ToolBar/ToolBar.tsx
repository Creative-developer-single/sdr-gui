    ...
    import { useMainController } from '../MainController/MainControllerProvider';
    ...
    function Toolbar({ activeMenuId }) {
        ...
        // 获取主控制器上下文
        const mainControllerContext = useMainController();

        console.log("Tabbar界面被刷新了，当前激活的菜单ID:", activeMenuId);
                                ...
                                item.item.map(item => (
                                    <button
                                        ...
                                        onClick={()=>{
                                            ...
                                            mainControllerContext.Actions.MainActionsController(activeMenuId,item);
                                        }}
                                    >
